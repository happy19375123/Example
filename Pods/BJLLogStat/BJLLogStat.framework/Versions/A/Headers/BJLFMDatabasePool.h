...
@interface BJLFMDatabasePool : NSObject
...
- (void)inDatabase:(__attribute__((noescape)) void (^)(BJLFMDatabase *db))block;
...
- (void)inTransaction:(__attribute__((noescape)) void (^)(BJLFMDatabase *db, BOOL *rollback))block;
...
- (void)inDeferredTransaction:(__attribute__((noescape)) void (^)(BJLFMDatabase *db, BOOL *rollback))block;
...
- (NSError * _Nullable)inSavePoint:(__attribute__((noescape)) void (^)(BJLFMDatabase *db, BOOL *rollback))block;
...
@interface NSObject (BJLFMDatabasePoolDelegate)
...
- (BOOL)bjl_databasePool:(BJLFMDatabasePool*)pool shouldAddDatabaseToPool:(BJLFMDatabase*)database;
...
- (void)bjl_databasePool:(BJLFMDatabasePool*)pool didAddDatabase:(BJLFMDatabase*)database;
