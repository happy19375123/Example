...
@interface BJLFMResultSet : NSObject

@property (nonatomic, retain, nullable) BJLFMDatabase *parentDB;
...
@property (atomic, retain, nullable) BJLFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(BJLFMStatement *)statement usingParentDatabase:(BJLFMDatabase*)aDB;
