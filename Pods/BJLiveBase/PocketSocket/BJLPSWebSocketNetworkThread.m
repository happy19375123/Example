...
#import "BJLPSWebSocketNetworkThread.h"

@interface BJLPSWebSocketNetworkThread() {
...
@end
@implementation BJLPSWebSocketNetworkThread
...
- (void)main {
    @autoreleasepool {
        ...
        [NSException raise:NSInternalInconsistencyException format:@"BJLPSWebSocketNetworkThread should never exit."];
    }
}
