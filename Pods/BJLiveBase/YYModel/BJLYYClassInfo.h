 ...
 */
@interface BJLYYClassIvarInfo : NSObject
@property (nonatomic, assign, readonly) Ivar ivar;              ///< ivar opaque struct
@property (nonatomic, strong, readonly) NSString *name;         ///< Ivar's name
@property (nonatomic, assign, readonly) ptrdiff_t offset;       ///< Ivar's offset
@property (nonatomic, strong, readonly) NSString *typeEncoding; ///< Ivar's type encoding
@property (nonatomic, assign, readonly) BJLYYEncodingType type;    ///< Ivar's type
...
/**
 Method information.
 */
@interface BJLYYClassMethodInfo : NSObject
...
@property (nullable, nonatomic, strong, readonly) NSDictionary<NSString *, BJLYYClassIvarInfo *> *ivarInfos; ///< ivars
@property (nullable, nonatomic, strong, readonly) NSDictionary<NSString *, BJLYYClassMethodInfo *> *methodInfos; ///< methods
