 ...
 */
+ (nullable instancetype)bjlyy_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)bjlyy_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)bjlyy_modelToJSONObject;
 ...
 */
- (nullable NSData *)bjlyy_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)bjlyy_modelToJSONString;
 ...
 */
+ (nullable NSArray *)bjlyy_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (BJLYYModel)
 ...
 */
+ (nullable NSDictionary *)bjlyy_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
